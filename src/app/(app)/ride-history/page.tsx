...
function RideHistoryList({ bookings }: { bookings: any[] | null }) {
    ...
    <>
      ...
      <Tabs defaultValue="rider">
        ...
        <TabsContent value="rider">
            {loadingRider ? <CarLoader /> : <RideHistoryList bookings={ridesAsRider} />}
        </TabsContent>
        <TabsContent value="driver">
            {loadingDriver ? <CarLoader /> : <RideHistoryList bookings={ridesAsDriver} />}
        </TabsContent>
      </Tabs>
    </>
  );
